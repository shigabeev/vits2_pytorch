...
class BigVGAN(torch.nn.Module):
    ...
    def __init__(self, initial_channel, resblock, resblock_kernel_sizes, resblock_dilation_sizes, upsample_rates, upsample_initial_channel, upsample_kernel_sizes, gin_channels=0, activation = "snake"):
        super(BigVGAN, self).__init__()

        # здесь мы используем аргументы, которые были переданы в функцию
        ...
        # post conv
        if activation == "snake": # periodic nonlinearity with snake function and anti-aliasing
            activation_post = activations.Snake(ch, alpha_logscale=True)
